package xin.framework.imageloader;
...
import xin.framework.imageloader.progress.OnProgressListener;
import xin.framework.imageloader.transformation.CircleTransformation;
import xin.framework.imageloader.transformation.RadiusTransformation;
...
public class GlideImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    public GlideImageView thumbnail() {// 50% 的缩略图
        getImageLoader().getGlideRequest().thumbnail(0.5f);
        return this;
    }
